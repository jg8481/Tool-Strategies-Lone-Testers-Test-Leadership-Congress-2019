...
if [ "$1" == "All-Tests-Passed-Do-Long-Graphwalker-Run" ]; then
  ...
  echo
  echo
  echo "The following will use LongGraphwalkerPath.csv to run the test sequence that was generated by the graphwalker-cli-3.4.2.jar file."
  echo
  echo
...
if [ "$1" == "Long-Graphwalker-Run-Detected-Errors-Do-Previous-Run" ]; then
  ...
  echo
  echo
  echo "The following will use the previous LongGraphwalkerPath.csv to run the test sequence that was generated by the graphwalker-cli-3.4.2.jar file."
  echo
  echo
  while IFS=, read -r GRAPHWALKER
  do
...
if [ "$1" == "Short-Graphwalker-Run-Detected-Errors-Do-Previous-Run" ]; then
  ...
  echo
  echo
  echo "The following will use the previous ShortGraphwalkerPath.csv to run the test sequence that was generated by the graphwalker-cli-3.4.2.jar file."
  echo
  echo
  while IFS=, read -r GRAPHWALKER
  do
